...
| `sso.roles.enabled`                  | boolean to enable/disable role mapping from ID token claim (supports currently role "admin" and "user")                                                                  | `false`                                                                                                                                         |
| `sso.roles.defaultToUser`            | boolen to assign user role as fallback if no role claim was found. (users without a "user" role can't login).                                                            | `true`                                                                                                                                          |
| `sso.roles.tokenPath`                | is used to specify the path to the roles claim inside the ID token.                                                                                                      | `""`                                                                                                                                            |
| `sso.organizations.enabled`          | boolean to enable/disable automatic organization mapping for SSO users. (Only works with the release build from https://github.com/Timshel/vaultwarden as we await a PR) | `false`                                                                                                                                         |
| `sso.organizations.inviteAll`        | boolean to enable/disable automatic invitation to all organizations in vaultwarden.                                                                                      | `false`                                                                                                                                         |
| `sso.organizations.inviteAutoAccept` | boolean to enable/disable automatic acceptance of organization invites.                                                                                                  | `false`                                                                                                                                         |
| `sso.organizations.enableRevocation` | boolen to control if user membership from organizations can be revoked by IDP                                                                                            | `false`                                                                                                                                         |
| `sso.organizations.tokenPath`        | is used to specify the path to the groups claim inside the ID token.                                                                                                     | `""`                                                                                                                                            |
| `sso.organizations.mappings`         | is used to map IDP group id's to vaultwarden group id's. (format: "ProviderId:VaultwardenId;", seperated by ";")                                                         | `""`                                                                                                                                            |
